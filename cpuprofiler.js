...
// EMTIMER-compatibility:
if (!performance.realNow) performance.realNow = performance.now;

// FPSCounter
var fpsCounterTicks = [];
var fpsCounterLastPrint = performance.realNow();
var avgs = [];
...
function cpuprofiler_frameStart() {
  cpuprofiler_currentframe_starttime = performance.realNow();//_emscripten_get_now();
  fpsCounter();
}
...
function cpuprofiler_frameEnd() {
  ...
  var t = performance.realNow();//_emscripten_get_now();
